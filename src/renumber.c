 ...
 *****************************************************************************************
 *                $Id: renumber.c 1330 2005-12-05 03:23:24Z halkeye $                *
 ****************************************************************************************/
/*
...
CMDF do_renumber(CHAR_DATA * ch, char *argument)
{
        ...
        {
                ch_printf(ch,
                          "What will be the new vnum base for this area?\n\r");
                return;
        }
        if (!is_number(arg1))
        {
        ...
        while (area)
        {
                if (tarea == area)
                        ;
                         ...
                         || !(high < area->low_o_vnum
                              || low > area->hi_o_vnum)
                         || !(high < area->low_m_vnum
                              || low > area->hi_m_vnum))
                {
                        ch_printf(ch,
                        ...
                        if (pexit->rvnum != i)
                        {
                                ...
                                rev_exit =
                                        get_exit_to(pexit->to_room,
                                                    rev_dir[pexit->vdir],
                                                    old_vnum);
                                if (rev_exit && pexit->to_room->area != area)
                                {
                                        if (rev_exit->vnum != i)
                                        {
                                                pager_printf(ch,
